...
public class Physic implements Component{
    ...
    public void fallSmoothly(){
        ...
        fallingMovement.setX(this.oldPosX + ImprovedNoise.map((float)ImprovedNoise.noise(this.perlinSeed,0,0),-GlobalConstants.PERLIN_CONST,GlobalConstants.PERLIN_CONST,-1f,1f));
